  ...
  <header>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link waves-effect" href="eventsDashboard.php">Map View
              <span class="sr-only">(current)</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link waves-effect" href="pwaluguview.php"">3D View
              </a> 
            </li>
          </ul>
    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="pwalugumap.php" class="list-group-item active waves-effect">
...
<main class="pt-5 mx-lg-5">
    <div class="card">
        ...
        <!-- Card header -->
        <div class="card-header">Pwalugu Project Map</div>
...
<!--Main layout-->
  ...
  <!--ckeditor start-->
  <script>
    ClassicEditor.create(document.getElementById('eventCont'));
  </script>
