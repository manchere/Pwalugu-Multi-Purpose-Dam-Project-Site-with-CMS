  ...
  <header>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link waves-effect" href="eventsDashboard.php">Manage Events
                <span class="sr-only">(current)</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link waves-effect" href="progDashboard.php"">Manage
                Programmes</a>
            </li>
          </ul>
    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="eventsDashboard.php" class="list-group-item active waves-effect">
    ...
    <div class="container-fluid mt-5">
      ...
      <div class="card mb-4 wow fadeIn">
        ...
        <div class="card-body d-sm-flex justify-content-between">
          ...
          <form class="d-flex justify-content-center">
            <!-- Default input -->
            <input type="search" placeholder="Search Events" aria-label="Search" class="form-control">
      ...
      <div class="row wow fadeIn">
        ...
        <div class="col-md-9 mb-4">
          <!--Card-->
          <form method="post" action = "eventHandling.php" enctype="multipart/form-data">
            <div class="card">
              <!--Card content-->
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control rounded-1" name="eventTitle">

                  <label for="eventLoc">Event Location</label>
                  <input class="form-control rounded-1" name="eventLoc">

                  <label for="eventSDate">Event Start Date</label>
                  <input type="date" class="form-control rounded-1" name="eventSDate">

                  <label for="eventEDate">Event End Date</label>
                  <input type="date" class="form-control rounded-1" name="eventEDate">

                  <label for="eventTime">Event Time</label>
                  <input class="form-control rounded-1" name="eventTime">

                  <label for="eventCat">Event Category</label>
                  <input type="" class="form-control rounded-1" name="eventCat">  

                  <label for="eventDesc">Event Description</label>
                  <textarea class="form-control rounded-1" id ="eventDesc" name="eventDesc" rows="4"></textarea>
                      
                  <input class="btn btn-primary rounded-1 mt-3" type="submit" value="Add Event" name="addEvent">

                  <input class="btn btn-primary rounded-1 mt-3" type="submit" value="Update Event" name="updateEvent">

                  <span>
                  <?php $fullURL = "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
                    if(strpos($fullURL,"mess=4") == true)
                    {
                      echo '<span class="text-danger">Missing field required</span><br>';
                    }
                    if(strpos($fullURL,"mess=3") == true)
                    {
                      echo '<span class="text-danger">An Event with the same Event title has already been added</span><br>';
                    }
                    if(strpos($fullURL,"mess=2") == true)
                    {
                      echo '<span class="text-danger">Event insertion failed</span><br>';
                    }
                    if(strpos($fullURL,"mess=1") == true)
                    {
                      echo '<span class="text-success">Event added successfully</span><br>';
                    }
                    if(strpos($fullURL,"err=1") == true)
                    {
                      echo '<span class="text-danger">End date is smaller than start date</span><br>';
                    }
                    ?>
                  </span>
                </div>
      ...
      <div class="card">
                      ...
                      while ($row = $result->fetch_assoc()) {
                          ?>
                                        <tr>
                                            ...
                                            <td class="align-middle" ><a class="btn btn-primary btn-sm rounded-1" data-toggle="modal" data-target="#eventDelete"
                                                data-backdrop="false">Delete event</a></td>
                                        </tr>
                                      <?php
                      }
                  }
        ...
        <div class="modal fade bottom" id="eventDelete" tabindex="-1" role="dialog"
                                          ...
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                              <div class="row d-flex justify-content-center align-items-center">
                                                ...
                                                <p class="pt-3 pr-2">Are you sure you want to delete this event?</p>

                                                <a role="button" class="btn btn-primary" href="processNews.php?Eventsid=<?php echo $row['Events_ID']; ?>">Yes
