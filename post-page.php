...
<!--Call to action-->
<div class="pt-4">
  <a class="btn btn-outline-white" href="htttp://www.vra.com" target="_blank"
    role="button">Volta River Authority
    <!-- <i class="fas fa-download ml-2"></i> -->
   <img src="img/Logos/vraOnly.png" width="40px" height="38px">
  </a>
</div>
<!--/.Call to action-->
