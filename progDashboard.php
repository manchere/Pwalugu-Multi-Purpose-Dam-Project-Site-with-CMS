...
<?php include 'dbConnect.php';?>
  ...
  <header>
    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <div class="list-group list-group-flush">   
        ...
        <a href="pwalugumpap.php" class="list-group-item list-group-item-action waves-effect">
    ...
    <div class="container-fluid mt-5">
      ...
      <div class="card mb-4 wow fadeIn">
        ...
        <div class="card-body d-sm-flex justify-content-between">
          ...
          <h4 class="mb-2 mb-sm-0 pt-1">
            <a href="#" target="_blank">Programmes</a>
            <span>|</span>
            <span>Dashboard</span>
          </h4>
          ...
          <form method="post" action = "eventHandling.php" enctype="multipart/form-data">
            <!-- Default input -->
            <input type="search" placeholder="Search Programmes" aria-label="Search" class="form-control">
      ...
      <div class="row wow fadeIn">
        ...
        <div class="col-md-9 mb-4">
         ...
         <form method="post" action="progHandling.php" enctype="multipart/form-data">
             <!--Card-->
          <div class="card">
            <!--Card content-->
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input class="form-control rounded-1" name="progTitle">

                <label for="progDate">Programme Date</label>
                <input type="date" class="form-control rounded-1" name="progDate">

                <label for="progTime">Programme Time</label>
                <input class="form-control rounded-1" name="progTime">

                <label for="progDesc">Programme Description</label>
                <textarea class="form-control rounded-1" name="progDesc" rows="3"></textarea>

                <label for="progImage">Programme Background Image</label>
                      <div class="form-group">
                        <div class="input-group">
                        </div>
                        <div class="custom-file">
                          <input type="file" class="custom-file-input" name="progImage"
                            aria-describedby="inputGroupFileAddon01">
                          <label class="custom-file-label" for="progImage">Choose file</label>
                        </div>
                      </div>

                <label for="progCont">Programme Content</label>
                <textarea class="form-control rounded-1" name="progCont" id="progCont" rows=10></textarea>
                </textarea>
                <input class="btn btn-primary rounded-1 mt-3" type="submit" value="Add Programme" name="addProg">
                <span class="bg-dark">
                  <?php $fullURL = "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
                    if(strpos($fullURL,"message=1") == true)
                    {
                        echo'<small class="text-success">Programme added successfully</small><br>';
                    }
                    if(strpos($fullURL,"message=2") == true)
                    {
                        echo'<small class="text-danger">Programme insertion failed</small>';
                    }
                    if(strpos($fullURL,"message=3") == true)
                    {
                      echo '<small class="text-danger">A programme with the same news title has already been added</small><br>';
                    }
                    if(strpos($fullURL,"message=4") == true)
                    {
                  ...
                  if ($result->num_rows > 0) {
                      while ($row = $result->fetch_assoc()) {
                        $validDate = date('d-m-Y',strtotime($row['Prog_date']));
                          ?>
                                        <tr>
                                            <th scope="row"><?php echo $row['Prog_ID']; ?></th>
                                            <td><?php echo $row['Prog_title']; ?></td>
                                            <td><?php echo $validDate; ?></td>
                                        </tr>
                                      <?php
                      }
                  }
  ...
  <script>
    ClassicEditor
      .create(document.querySelector('#progCont'), {
